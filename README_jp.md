...
1. 最新のPortablePipelineのリリースをダウンロードして解凍する。  
 Win https://github.com/c2997108/OpenPortablePipeline/releases/download/v1.0/PortablePipeline-win-v1.0.1.zip  
 Mac https://github.com/c2997108/OpenPortablePipeline/releases/download/v1.0/PortablePipeline-mac-v1.0.1.tar.gz 
...
- dockerを使う場合は途中でキャンセル処理はSGEなしの場合のみ完全対応。SGEを使うとqsubで投げたjobは削除するが、投げた先のサーバの中のdockerは停止させられるか未確認。singularityの場合はSGEでもSGEがプロセスを停止させてくれるはず。
