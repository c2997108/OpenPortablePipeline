...
- MacでHomebrewのcoreutilsなどとDocker Desktop for MacをインストールしたMac : [Macサーバセットアップ方法](#macをサーバとして使用する場合のセットアップ方法-m1以降のmac)。Dockerの仮想マシンの仮想ディスクが少ないので、容量が少なくて動かないスクリプトがある。
