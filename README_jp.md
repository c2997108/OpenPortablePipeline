...
1. 最新のPortablePipelineのリリースをダウンロードして解凍する。  
 Win https://github.com/c2997108/OpenPortablePipeline/releases/download/v0.7d/PortablePipeline-win-v0.7e.zip  
 Mac https://github.com/c2997108/OpenPortablePipeline/releases/download/v0.7d/PortablePipeline-mac-v0.7e.tar.gz 
...
- ダウンロードさせるファイルの中に、ディレクトリへのシンボリックリンクが入っているとエラーでその先に進まない。いずれ対策予定。
